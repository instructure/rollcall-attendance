...
describe AttendanceAssignment do
  ...
  describe "submit_grade" do
    ...
    it "grades the assignment through canvas" do
      ...
      attendance_assignment.submit_grade('assignment id', 'student id', 'section id')
    end
    ...
    it "fails gracefully when the user is not authorized to update grades" do
      ...
      expect { attendance_assignment.submit_grade('assignment id', 'student id', 'section id') }.to_not raise_error
    end
  end
